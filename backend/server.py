...
# """,
#     "Consumer Review": """Analyze this ketchup review video and extract the reviewer or consumer reaction in detail. For this, provide:
...
# # -------------------------------------------------------------------
# # MARKETING ANALYSIS CONFIG
# # -------------------------------------------------------------------
# PROMPT_OPTIONS: Dict[str, str] = {
#     "Consumer Impact & Engagement": """**Context:**
...
#     "YouTube": "Advertisement of a ketchup product, highlighting taste, quality, and packaging."
# }
...
#     """Analyze a video for multiple selected prompts."""
...
# **Instructions:**
# 1. Summarize main themes.
# 2. Identify sentiment (positive, negative, neutral).
# 3. Extract product feedback, complaints, or praise.
...
# async def comment_analysis(data: dict = Body(...)):
#     """Analyze comments for a given YouTube video URL."""
#     video_url = data.get("video_url")
#     if not video_url:
#         return {"error": "Missing 'video_url' in request body"}
#     insights = analyze_youtube_comments(video_url)
...
6. **Summary:** Provide a concise overview of the audio content in 2–3 sentences.  
""",
    "Product Theme": """Analyze this video and extract the product theme in detail. Provide:
1. **Theme / Main Feature**
2. **Sentiment**
3. **Explanation**
""",
    "Ingredients": """Analyze this video and extract information about the product's ingredients. Provide:
1. **Ingredients**
2. **Sentiment**
3. **Explanation**
""",
    "Consumer Review": """Analyze this review video and extract the consumer reaction:
1. **Reaction**
2. **Sentiment**
3. **Explanation**
""",
    "Packaging": """Analyze this video and extract packaging details:
1. **Package Type & Sentiment**
2. **Explanation**
3. **Package Size / Variants & Sentiment**
4. **Explanation**
""",
}
...
PROMPT_OPTIONS: Dict[str, str] = {
    "Consumer Impact & Engagement": """**Context:**  
You are an audience member watching a new advertisement video. The video is [description of the video].  
**Persona Description:**  
[persona details]  

**Instructions:**  
1. Evaluate: Attention, Clarity, Relevance, Emotional Appeal, Persuasiveness, Memorability  
2. Provide a score (1–5) for each attribute  
3. Present results in a **markdown table**  
4. Briefly justify each score  
""",
    "Brand & Creative Quality": """**Context:**  
You are an audience member watching a new advertisement video.  

**Instructions:**  
1. Evaluate: Brand Presence, Product Appeal, Packaging Visibility, Consistency, Distinctiveness, CTA Strength  
2. Provide a score (1–5) for each attribute  
3. Present results in a markdown table  
4. Justify briefly  
""",
    "Regulatory & Claims Compliance (U.S.)": """**Context:**  
You are an audience member watching a new advertisement video.  

**Instructions:**  
1. Evaluate: FDA/FTC Claim Accuracy, Nutrition Claims, Structure/Function Claims, USDA Rules, Allergen Disclosure, Comparative Claims, Children’s Standards, Disclaimers  
2. Provide a score (1–5) for each attribute  
3. Present results in a markdown table  
4. Justify briefly  
""",
...
PERSONA_DICT = {
    "Male": "I am a 30-year-old male urban professional interested in cooking and convenience.",
    "Female": "I am a 28-year-old female urban professional focused on wellness and sustainability.",
    "Kids": "I am a 10-year-old kid who loves colorful foods and cartoons.",
    "Teens": "I am a 16-year-old teen influenced by social media and friends' recommendations.",
    "Adults": "I am a 40-year-old adult who values quality and trusted brands.",
    "Seniors": "I am a 65-year-old senior prioritizing health and clear labeling.",
}
